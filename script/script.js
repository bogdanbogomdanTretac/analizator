...
function vowelsCount(text){// усі голосні символи 
    let vowelsCount = 0;
    let vowels = ['а','і','у','е','и','о','є','ю','ї','я' , 'a', 'e', 'i', 'o', 'u', 'A', 'E', 'I', 'O', 'U'];
...
function consCount_fun(text){ // усі приголосні символи 
  let consCount = 0;
  let cons = ['к','н','г','ш','щ','з','х','ф','в','п', "р",'л','д','ж','ч','с' ,'м' ,'т' ,'б' , 'b', 'B', 'c', 'C', 'd', 'D', 'f', 'F', 'g', 'G', 'h', 'H', 'j', 'J', 'k', 'K', 'l', 'L', 'm', 'M', 'n', 'N', 'p', 'P', 'q', 'Q', 'r', 'R', 's', 'S', 't', 'T', 'v', 'V', 'w', 'W', 'x', 'X', 'y', 'Y', 'z', 'Z'];
